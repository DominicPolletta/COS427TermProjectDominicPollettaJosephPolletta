...
# Fit the data
OVR.fit(FeaturesTrain, TargetsTrain)

# Use OVR to predict values
TargetsPred = OVR.predict(FeaturesTest)
...
# Fit the data
OVO.fit(FeaturesTrain, TargetsTrain)

# Use OVO to predict values
TargetsPred = OVO.predict(FeaturesTest)
