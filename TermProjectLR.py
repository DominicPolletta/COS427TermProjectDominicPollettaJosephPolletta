...
# Define stopword list, tokenizer, stemmer, lemmatizer, and Linear Model
...
# Fit the data
LR.fit(FeaturesTrain, TargetsTrain)

# Use LR to predict values
TargetsPred = LR.predict(FeaturesTest)
